...
describe('SuccessModal', () => {
  ...
  it('should not render when isOpen is false', () => {
    render(<SuccessModal isOpen={false} productId="123" onCreateAnother={mockOnCreateAnother} />)

    expect(screen.queryByText(/Producto guardado exitosamente/i)).not.toBeInTheDocument()
  })

  it('should render when isOpen is true', () => {
    render(<SuccessModal isOpen={true} productId="123" onCreateAnother={mockOnCreateAnother} />)
  ...
  it('should navigate to products list when no productId is provided', () => {
    render(<SuccessModal isOpen={true} onCreateAnother={mockOnCreateAnother} />)
  ...
  it('should reset countdown when modal is reopened', () => {
    const { rerender } = render(
      <SuccessModal isOpen={true} productId="123" onCreateAnother={mockOnCreateAnother} />,
    )
    ...
    // Reopen modal
    rerender(<SuccessModal isOpen={true} productId="123" onCreateAnother={mockOnCreateAnother} />)
